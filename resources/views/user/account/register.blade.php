                                ...
                                <div class="padding_eight_all bg-white">
                                    ...
                                    <form action="{{ route('register') }}" method="POST">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="@error('name') is-invalid @enderror" required=""
                                        ...
                                        <div class="form-group">
                                            <input class="@error('password') is-invalid @enderror" type="email"
                                        ...
                                        <div class="form-group">
                                            <input class="@error('password') is-invalid @enderror" required=""
                                        ...
                                        <div class="form-group">
                                            <input class="@error('password_confirmation') is-invalid @enderror" required="" type="password" name="password_confirmation"
                        ...
                        <div class="col-lg-6 pr-30 d-none d-lg-block">
                            <div class="card-login mt-115">
                                <a href="#" class="social-login facebook-login">
                                    <img src="{{ asset('user/assets/imgs/theme/icons/logo-facebook.svg') }}"
                                        alt="" />
                                    <span>Continue with Facebook</span>
                                </a>
                                <a href="{{ route('google.login') }}" class="social-login google-login">
                                    <img src="{{ asset('user/assets/imgs/theme/icons/logo-google.svg') }}"
                                        alt="" />
                                    <span>Continue with Google</span>
                                </a>
                                <a href="#" class="social-login apple-login">
                                    <img src="{{ asset('user/assets/imgs/theme/icons/logo-apple.svg') }}"
                                        alt="" />
