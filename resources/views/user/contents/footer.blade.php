            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="position-relative newsletter-inner">
                        ...
                        <img src="{{ asset('user/assets/imgs/banner/banner-9.png')}}" alt="newsletter" />
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col">
                    <div class="widget-about font-md mb-md-3 mb-lg-3 mb-xl-0 wow animate__animated animate__fadeInUp" data-wow-delay="0">
                        <div class="logo mb-30">
                            <a class='mb-15' href='index.html'><img src="{{ asset('user/assets/imgs/theme/logo.svg')}}" alt="logo" /></a>
                ...
                <div class="footer-link-widget widget-install-app col wow animate__animated animate__fadeInUp" data-wow-delay=".5s">
                    ...
                    <div class="download-app">
                        <a href="#" class="hover-up mb-sm-2 mb-lg-0"><img class="active" src="{{ asset('user/assets/imgs/theme/app-store.jpg')}}" alt="" /></a>
                        <a href="#" class="hover-up mb-sm-2"><img src="{{ asset('user/assets/imgs/theme/google-play.jpg')}}" alt="" /></a>
                    </div>
                    <p class="mb-20">Secured Payment Gateways</p>
                    <img class="" src="{{ asset('user/assets/imgs/theme/payment-method.png')}}" alt="" />
                </div>
            </div>
    </section>
