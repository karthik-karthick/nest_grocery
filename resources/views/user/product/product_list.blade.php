...
@section('user_layout')
    ...
    <link rel="stylesheet" href="{{ asset('user/assets/css/main5103.css') }}?v=6.0" />
            ...
            <div class="col-lg-4-5">
                <div class="shop-product-fillter">
                    <div class="totall-product">
                        <p>We found <strong class="text-brand">@php
                            $found = $product->count();
                        @endphp {{ $found }}</strong> items for you!
                        </p>
                    </div>
                            ...
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="{{ route('prod.detail', ['id' => $products->id]) }}">
                                            <img class="default-img" src="{{ asset($products->product_image) }}"
                                                alt="" />
                                            <img class="hover-img" src="{{ asset($products->product_image) }}"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                                        <a aria-label='Add To Wishlist' onclick="addwishlist({{ $products->id }});"
                                            class='action-btn' href='javascript:;'><i class="fi-rs-heart"></i></a>
                                        <a aria-label='Compare' class='action-btn' href='javascript:;'><i
                                    ...
                                    <div class="product-badges product-badges-position product-badges-mrg">
                                        @php
                                            $percents =
                                                (($products->product_price - $products->selling_price) /
                                ...
                                <div class="product-content-wrap">
                                    ...
                                    <h2><a href='shop-product-right.html'>{{ $products->product_name }}</a></h2>
                                    ...
                                    <div class="product-card-bottom">
                                        ...
                                        <div class="add-cart">
                                            <a class='add'onclick="addtocart({{ $products->id }})"
                                                href='javascript:;'><i class="fi-rs-shopping-cart mr-5"></i>Add </a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="product-img-action-wrap">
                                    <div class="product-img">
                                        <a href='shop-product-right.html'>
                                            <img src="{{ asset('user/assets/imgs/banner/banner-5.png') }}"
                                                alt="" />
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6">
                            <div class="product-cart-wrap style-2">
                                <div class="product-img-action-wrap">
                                    <div class="product-img">
                                        <a href='shop-product-right.html'>
                                            <img src="{{ asset('user/assets/imgs/banner/banner-6.png') }}"
                                                alt="" />
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 d-none d-lg-block">
                            <div class="product-cart-wrap style-2">
                                <div class="product-img-action-wrap">
                                    <div class="product-img">
                                        <a href='shop-product-right.html'>
                                            <img src="{{ asset('user/assets/imgs/banner/banner-7.png') }}"
                                                alt="" />
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 d-none d-xl-block">
                            <div class="product-cart-wrap style-2">
                                <div class="product-img-action-wrap">
                                    <div class="product-img">
                                        <a href='shop-product-right.html'>
                                            <img src="{{ asset('user/assets/imgs/banner/banner-8.png') }}"
                                                alt="" />
                                        </a>
                                    </div>
                                </div>
            ...
            <div class="col-lg-1-5 primary-sidebar sticky-sidebar">
                <div class="sidebar-widget widget-category-2 mb-30">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href='shop-grid-right.html'> <img
                                    src="{{ asset('user/assets/imgs/theme/icons/category-3.svg') }}" alt="" />Pet
                ...
                <div class="sidebar-widget price_range range mb-30">
                    ...
                    <a class='btn btn-sm btn-default' href='shop-grid-right.html'><i class="fi-rs-filter mr-5"></i>
                        Fillter</a>
                </div>
