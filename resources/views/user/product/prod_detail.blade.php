                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12 mb-md-0 mb-sm-5">
                        <div class="detail-gallery">
                            ...
                            <div class="slider-nav-thumbnails">
                                <div><img src="{{ asset($product->product_image)}}" alt="product image" /></div>
                                <div><img src="{{ asset($product->product_image)}}" alt="product image" /></div>
                                <div><img src="{{ asset($product->product_image)}}" alt="product image" /></div>
                                <div><img src="{{ asset($product->product_image)}}" alt="product image" /></div>
                                <div><img src="{{ asset($product->product_image)}}" alt="product image" /></div>
                        ...
                        <div class="detail-info pr-30 pl-30">
                            ...
                            <div class="detail-extralink mb-50">
                                ...
                                <div class="product-extra-link2">
                                    <button type="button" onclick="addtocart({{ $product->id }})" class="button button-add-to-cart"><i class="fi-rs-shopping-cart"></i>Add to cart</button>
                                    @guest
                                    <a title="Add to wishlist" aria-label='Add To Wishlist'onclick="addwishlist({{ $product->id }});" class='action-btn hover-up' href='javascript:;'><i class="fi-rs-heart"></i></a>

                                    @else
                                    @if ($iswishlist)
                                    <a title="Remove wishlist" aria-label='Add To Wishlist'onclick="addwishlist({{ $product->id }});" class='action-btn hover-up' href='javascript:;'><i class="fi-rs-heart text-danger" ></i></a>
                                    @else
                                    <a title="Add to wishlist" aria-label='Add To Wishlist'onclick="addwishlist({{ $product->id }});" class='action-btn hover-up' href='javascript:;'><i class="fi-rs-heart"></i></a>
                                    @endif
                                    @endguest
                                    
                                    <a aria-label='Compare' class='action-btn hover-up' href='javascript:;'><i class="fi-rs-shuffle"></i></a>
                                </div>
                            </div>
                            <div class="font-xs">
                                <ul class="mr-50 float-start">
                                    <li class="mb-5">Type: <span class="text-brand">{{$product->tag_name}}</span></li>
                                    <li class="mb-5">MFG:<span class="text-brand"> Jun 4.2024</span></li>
                                    <li>LIFE: <span class="text-brand">70 days</span></li>
                                </ul>
                                <ul class="float-start">
                                    <li class="mb-5">SKU: <a href="#">{{$product->sku}}</a></li>
                                    <li class="mb-5">Tags: <a href="#" rel="tag">{{$product->tag_name}}</a></li>
                                    <li>Stock:
                                        @if ($product->current_stock > 10)  
                                        <span class="in-stock text-brand ml-5"><b> In Stock</span>
                                            @elseif ($product->current_stock == 0)
                                            <span class="in-stock text-danger ml-5"><b> Out Of Stock</b></span>                                        

                                        @else
                                        <span class="in-stock text-danger ml-5"><b> {{$product->current_stock}} only left</b></span>                                        
                                    @endif</li>
                                </ul>
                            </div>
                        </div>
                                ...
                                <div class="product-cart-wrap hover-up">
                                    <div class="product-img-action-wrap">
                                        ...
                                        <div class="product-action-1">
                                            ...
                                            <a aria-label='Compare' class='action-btn small hover-up' href='javascript:;' tabindex='0'><i class="fi-rs-shuffle"></i></a>
                                        </div>
