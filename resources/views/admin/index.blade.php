					...
					<div class="card radius-10 w-100">
						...
						<div class="customers-list p-3 mb-3">
							<div class="customers-list-item d-flex align-items-center border-top border-bottom p-2 cursor-pointer">
								<div class="">
									<img src="{{asset('admin/assets/images/avatars/avatar-1.png')}}" class="rounded-circle" width="46" height="46" alt="" />
								</div>
								<div class="ms-2">
							...
							<div class="customers-list-item d-flex align-items-center border-bottom p-2 cursor-pointer">
								<div class="">
									<img src="{{asset('admin/assets/images/avatars/avatar-2.png')}}" class="rounded-circle" width="46" height="46" alt="" />
								</div>
								<div class="ms-2">
							...
							<div class="customers-list-item d-flex align-items-center border-bottom p-2 cursor-pointer">
								<div class="">
									<img src="{{asset('admin/assets/images/avatars/avatar-3.png')}}" class="rounded-circle" width="46" height="46" alt="" />
								</div>
								<div class="ms-2">
							...
							<div class="customers-list-item d-flex align-items-center border-bottom p-2 cursor-pointer">
								<div class="">
									<img src="{{asset('admin/assets/images/avatars/avatar-4.png')}}" class="rounded-circle" width="46" height="46" alt="" />
								</div>
								<div class="ms-2">
							...
							<div class="customers-list-item d-flex align-items-center border-bottom p-2 cursor-pointer">
								<div class="">
									<img src="{{asset('admin/assets/images/avatars/avatar-5.png')}}" class="rounded-circle" width="46" height="46" alt="" />
								</div>
								<div class="ms-2">
							...
							<div class="customers-list-item d-flex align-items-center border-bottom p-2 cursor-pointer">
								<div class="">
									<img src="{{asset('admin/assets/images/avatars/avatar-6.png')}}" class="rounded-circle" width="46" height="46" alt="" />
								</div>
								<div class="ms-2">
							...
							<div class="customers-list-item d-flex align-items-center border-bottom p-2 cursor-pointer">
								<div class="">
									<img src="{{asset('admin/assets/images/avatars/avatar-7.png')}}" class="rounded-circle" width="46" height="46" alt="" />
								</div>
								<div class="ms-2">
							...
							<div class="customers-list-item d-flex align-items-center border-bottom p-2 cursor-pointer">
								<div class="">
									<img src="{{asset('admin/assets/images/avatars/avatar-8.png')}}" class="rounded-circle" width="46" height="46" alt="" />
								</div>
								<div class="ms-2">
							...
							<div class="customers-list-item d-flex align-items-center border-bottom p-2 cursor-pointer">
								<div class="">
									<img src="{{asset('admin/assets/images/avatars/avatar-9.png')}}" class="rounded-circle" width="46" height="46" alt="" />
								</div>
								<div class="ms-2">
							...
							<div class="customers-list-item d-flex align-items-center border-bottom p-2 cursor-pointer">
								<div class="">
									<img src="{{asset('admin/assets/images/avatars/avatar-10.png')}}" class="rounded-circle" width="46" height="46" alt="" />
								</div>
								<div class="ms-2">
						...
						<div class="product-list p-3 mb-3">
							 ...
							 <div class="d-flex align-items-center py-3 border-bottom cursor-pointer">
								<div class="product-img me-2">
									 <img src="{{asset('admin/assets/images/products/01.png')}}" alt="product img">
								  </div>
								<div class="">
							  ...
							  <div class="d-flex align-items-center py-3 border-bottom cursor-pointer">
								<div class="product-img me-2">
									 <img src="{{asset('admin/assets/images/products/03.png')}}" alt="product img">
								  </div>
								<div class="">
							  ...
							  <div class="d-flex align-items-center py-3 border-bottom cursor-pointer">
								<div class="product-img me-2">
									 <img src="{{asset('admin/assets/images/products/04.png')}}" alt="product img">
								  </div>
								<div class="">
							  ...
							  <div class="d-flex align-items-center py-3 border-bottom cursor-pointer">
								<div class="product-img me-2">
									 <img src="{{asset('admin/assets/images/products/05.png')}}" alt="product img">
								  </div>
								<div class="">
							  ...
							  <div class="d-flex align-items-center py-3 border-bottom cursor-pointer">
								<div class="product-img me-2">
									 <img src="{{asset('admin/assets/images/products/06.png')}}" alt="product img">
								  </div>
								<div class="">
							  ...
							  <div class="d-flex align-items-center py-3 border-bottom cursor-pointer">
								<div class="product-img me-2">
									 <img src="{{asset('admin/assets/images/products/07.png')}}" alt="product img">
								  </div>
								<div class="">
							  ...
							  <div class="d-flex align-items-center py-3 border-bottom cursor-pointer">
								<div class="product-img me-2">
									 <img src="{{asset('admin/assets/images/products/08.png')}}" alt="product img">
								  </div>
								<div class="">
							  ...
							  <div class="d-flex align-items-center py-3 border-bottom cursor-pointer">
								<div class="product-img me-2">
									 <img src="{{asset('admin/assets/images/products/09.png')}}" alt="product img">
								  </div>
								<div class="">
									<h6 class="mb-0 font-14">Brown Single Table</h6>
							  ...
							  <div class="d-flex align-items-center py-3 border-bottom cursor-pointer">
								<div class="product-img me-2">
									 <img src="{{asset('admin/assets/images/products/10.png')}}" alt="product img">
								  </div>
								<div class="">
							  ...
							  <div class="d-flex align-items-center py-3 border-bottom cursor-pointer">
								<div class="product-img me-2">
									 <img src="{{asset('admin/assets/images/products/11.png')}}" alt="product img">
								  </div>
								<div class="">
									   ...
									   <tbody>
											   ...
											   <td>
												<div class="d-flex align-items-center">
													<div class="recent-product-img">
														<img src="{{asset('admin/assets/images/products/15.png')}}" alt="">
													</div>
													<div class="ms-2">
										   ...
										   <tr>
											...
											<td>
											 <div class="d-flex align-items-center">
												 <div class="recent-product-img">
													 <img src="{{asset('admin/assets/images/products/16.html')}}" alt="">
												 </div>
												 <div class="ms-2">
										...
										<tr>
											...
											<td>
											 <div class="d-flex align-items-center">
												 <div class="recent-product-img">
													 <img src="{{asset('admin/assets/images/products/14.png')}}" alt="">
												 </div>
												 <div class="ms-2">
