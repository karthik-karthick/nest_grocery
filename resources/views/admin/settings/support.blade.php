    ...
    <div class="page-content">
      ...
      <div class="card">
          <div class="card-body p-4">
              <h5 class="card-title">Support Policy</h5>
              <hr/>
               <div class="form-body mt-4">
                <div class="row">
                   <div class="col-lg-12">                   
                    {{-- <div class="border border-3 p-4 rounded mt-3"> --}}
                        <form action="{{route('add.support')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <h4 class="card-title">Support Policy</h4>
                                        </div>
                                        <div class="card-body">
                                            @php
                                    $id = $support->id ?? null;
                                ...
                                <input type="hidden" name="support_id" value="{{ $id }}">
                                            <textarea  name="support_policy" id="ckeditor-classic" cols="30" rows="10">{{$value}}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
