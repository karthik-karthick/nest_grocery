                                      ...
                                      <div class="col-md-3 ">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input class="form-control  @error('product_thumbnail') is-invalid @enderror"
                                                name="product_thumbnail" type="file" id="imageview" required>
                                        ...
                                        <div class="col-md-3  my-3">
                                            ...
                                            <input type="text"
                                                ...
                                                id="" placeholder="Tag Name" value="{{ old('tag_name') }}"
                                                required>
                                            @error('tag_name')
                                                <span class="text-danger fw-bold">{{ $message }}</span>
                                            @enderror
                                        ...
                                        <div class="col-md-3  my-3">
                                          <label for="bsValidation1" class="form-label">Sku <span
                                                  class="text-danger">*</span></label>
                                          <input type="text"
                                              class="form-control @error('tag_name') is-invalid @enderror" name="sku"
                                              id="subCategorySku" placeholder="SKKU Name" value="{{ old('sku') }}"
                                              required>
                                          @error('sku')
                                              <span class="text-danger fw-bold">{{ $message }}</span>
                                          @enderror
                                        ...
                                        <div class="col-md-3 my-3">
                                            ...
                                            <input type="number" class="form-control @error('mrp_price') is-invalid @enderror" name="mrp_price"
                                                id="bsValidation1" placeholder="Enter Product Price" value="{{ old('mrp_price') }}"
                                                required>
                                        ...
                                        <div class="col-md-3 my-3">
                                            ...
                                            <input class="form-control @error('selling_price') is-invalid @enderror"
                                                ...
                                                placeholder="Enter Discount price" value="{{ old('selling_price') }}" required>
                                        ...
                                        <div class="col-md-3 my-3">
                                            ...
                                            <input type="number"
                                                ...
                                                placeholder="Enter Shipping Price" value="{{ old('shiping_price') }}" required>
                                        ...
                                        <div class="col-md-3 my-3">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ old('preorder_description') }}" required>
                                        ...
                                        <div class="col-md-3 ms-5">
                                            <img class=" p-1" id="product-image-preview"
                                                style="cursor: pointer; display:none" src=""
                                                alt="Product Thumbnail Preview" style="width: 100;" height="80">
