...
@section('admin_layout')
                                ...
                                <div class="border border-3 p-4 rounded">
                                    <form action="{{ route('add.category') }}" method="POST" enctype="multipart/form-data"
                                        ...
                                        <div class="col-md-4 me-4">
                                            <label for="bsValidation1" class="form-label">Category Name <span
                                                    class="text-danger">*</span></label>
                                            <input type="text"
                                                class="form-control @error('category_name') is-invalid @enderror"
                                                name="category_name" id="bsValidation1" placeholder="Category Name"
                                                value="{{ old('category_name') }}" required>
                                            @error('category_name')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror <div class="valid-feedback">
                                                Looks good!
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <label for="formFile" class="form-label">Category Image <span
                                                    class="text-danger">*</span></label>
                                            <input class="form-control  @error('category_image') is-invalid @enderror"
                                                name="category_image" type="file" id="imageview" required>
                                        ...
                                        <div class="col-md-3 ms-5">
                                            <img class=" p-1" id="category-image-preview" style="cursor: pointer; display:none"
                                                src="" 
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            {{-- <div class="table-responsive"> --}}
                                                <table id="tblCategoryList" class="table table-bordered"
                                                    >
                                                    <thead>
                                                        <tr>
                                                            <th>S.no</th>
	...
	<script src="{{ asset('admin/assets/js/admin/category.js')}}"></script>
@endsection
