...
$(document).on('click', '.edit-brand', function (e) {
    ...
    $.ajax({
        ...
        success: function (response) {
            $('input[name="brand_name"]').val(response.brand_name)
            $('#brand_id').val(response.id)
            if (response.brand_image) {
                var imageUrl = '/' + response.brand_image
                $('#brand-image-preview').attr('src', imageUrl).show()
            }
...
document
    ...
    .addEventListener('change', function (event) {
        ...
        reader.onload = function (e) {
            var imgElement = document.getElementById('brand-image-preview')
